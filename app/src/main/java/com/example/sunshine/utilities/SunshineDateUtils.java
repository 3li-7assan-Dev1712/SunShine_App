...
public final class SunshineDateUtils {
    ...
    public static long getNormalizedUtcDateForToday() {
        ...
        /*
        after getting the general elapsed milli seconds since the epoch
        we get the time zone then we use this time zone to modify the time
        we get offsets then we add the offsets the general milli seconds to represent the time
        for every zone in the world

        in other words timeSinceEpochLocalTimeMillis have a value in USA and another one in Sudan :)
         */
